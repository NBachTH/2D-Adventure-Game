...
public class UI {
    ...
    public void drawWinScreen() {
        ...
        text = "press ESC to exit to the main screen ";

        g2.setFont(g2.getFont().deriveFont(Font.PLAIN, 30F));
        g2.drawString(text, x + gp.tileSizeX*2, y + 2 * gp.tileSizeY);
    }
    ...
    public BufferedImage setupImage(String imagePath, int width, int height) {
        ...
        try {
            imag = ImageIO.read(getClass().getResourceAsStream(imagePath));
    ...
    public void drawInventory() {
        ...
        g2.drawString("Q to equip/use item", textX, textY);
        textY += gp.tileSizeY;
        g2.drawString("R to drop item", textX, textY);
